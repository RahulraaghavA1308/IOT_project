...
#define WIFI_PASSWORD "godiedadei"
...
#define DATABASE_URL "ambulance-iot-541-default-rtdb.firebaseio.com" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app
